...
{
    /// <inheritdoc />
    public partial class Intital_Data_Base : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityQuestion = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    SecurityAnswerHash = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Auth = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_SaleUnits_SaleUnitId",
                        column: x => x.SaleUnitId,
                        principalTable: "SaleUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleUnitName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ProductUnitOptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SaleUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QuantityPerBaseUnit = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUnitOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductUnitOptions_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUnitOptions_SaleUnits_SaleUnitId",
                        column: x => x.SaleUnitId,
                        principalTable: "SaleUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUnitOptions_ProductId_SaleUnitId",
                table: "ProductUnitOptions",
                columns: new[] { "ProductId", "SaleUnitId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductUnitOptions_SaleUnitId",
                table: "ProductUnitOptions",
                column: "SaleUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_PushSubscriptions_AdminUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleUnits_NormalizedName",
                table: "SaleUnits",
                column: "NormalizedName",
                unique: true);
        }
