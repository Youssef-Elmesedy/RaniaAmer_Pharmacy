// Service worker for Web Push notifications - صيدلية رانيا عامر
...
self.addEventListener('push', function (event) {
    ...
    try {
        ...
        data = { title: 'صيدلية رانيا عامر', body: event.data ? event.data.text() : 'لديك إشعار جديد' };
    }

    var title = data.title || 'صيدلية رانيا عامر';
    var options = {
        body: data.body || '',
